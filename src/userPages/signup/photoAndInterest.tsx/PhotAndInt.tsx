       ...
       async function fetectInterst(){
        try {
            ...
            if(error instanceof Error){
                alertWithOk('photo and interest updation',error.message||'internal server error','error')
            }
        }
  ...
  return (
    ...
    <div className='w-5/6 h-72 sm:mt-0 flex'>
        ...
        {interestCount.current!==5&&
            ...
            <select name="" id="" onChange={(t)=>handleCategoryInterest(t)} className='sm:w-[30%] w-[50%]   h-9 outline-none border border-theme-blue'>
            ...
            <select name="" id="" className='sm:w-[30%] w-[50%]    ml-10 h-9 outline-none border border-theme-blue' onChange={handleAddInterest}>
