      ...
      <div className="w-full lg:mt-0 mt-10 h-full ">
        ...
        <div className="w-full h-[90%]  md:ml-0 ml-5 flex justify-center items-center">
          <div className="md:w-[40%] w-[100%]  sm:w-[90%]  sm:h-[95%] h-[84%] rounded-3xl border shadow-3xl shadow-theme-blue bg-white sm:px-10 px-5 items-center flex flex-col">
            <h1 className="font-bold text-2xl text-dark-blue mt-2 mb-5">
              ADD PLAN
            </h1>
            <div className="sm:w-[100%] w-[100%] h-[15%] sm:h-[20%]     justify-between mb-2">
              <label
                htmlFor=""
                className="block font-inter font-bold md:text-base text-sm text-dark-blue"
              >
                NAME
              </label>
            ...
            <div className="w-[100%] h-[20%]  flex justify-between">
              <div className="w-[33%] h-full  ">
                ...
                <input
                  ...
                  value={datas.amount === 0 ? "" : datas.amount}
                  type="number"
              ...
              <div className="w-[33%] h-full ">
                ...
                <input
                  ...
                  value={datas.connect === 0 ? "" : datas.connect}
                  id="amount"
                  type="number"
              ...
              <div className="w-[33%] h-full">
                ...
                <select
                  ...
                  className="h-8 outline-none border-b border-theme-blue"
                  name=""
                  id=""
                >
            ...
            <div className="w-[100%] h-[30%] bg-gray-400">
              {handleFeatureState.map((el, index) => (
                <div
                  key={index}
                  className="w-full h-[20%] mt-2 bg-dark-blue  flex"
                >
                  ...
                  <div
                    ...
                    className="w-[10%] h-full text-center text-white font-black"
                  >
                    X
                  </div>
                </div>
            ...
            <button
              ...
              className="border-2 border-dark-blue text-dark-blue mt-2 w-[30%] h-[6%] font-bold  rounded-xl"
            >
              SUBMIT
            </button>
          </div>
